  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden bg-[#0A0F1C]">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute bottom-1/4 right-0 w-80 h-80 bg-indigo-500/15 rounded-full blur-[100px] animate-pulse delay-1000" />
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 lg:px-8 py-20">
        <div className="max-w-4xl">
          ...
          >
            ...
            <span className="text-sm text-blue-300 tracking-wide font-medium">
          ...
          >
            ...
            <a href="#contato">
              <Button
                variant="outline"
                size="lg"
                className="border-white/10 text-white/70 hover:text-white hover:bg-white/5 hover:border-white/20 px-8 py-6 text-base rounded-xl transition-all duration-300"
              >
                Fale Conosco
              </Button>
            </a>
